...
public class Response {
    ...
    public Response(String response) throws NullPointerException {
        String decryptedResponse = AES256.decrypt(response);
        msg = getMsgSave(decryptedResponse);
        head = getHeadSave(decryptedResponse);
        params = getParamsSave(decryptedResponse);
    }
